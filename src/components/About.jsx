...
const aboutData = {
  ...
  text: [
    "Somos un grupo de apasionados por el mundo digital conformado por un equipo de profesionales altamente calificados. Nos hemos unico con el objetivo de brindar soluciones integrales",
